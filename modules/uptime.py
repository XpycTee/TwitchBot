...
def responder(message, username):
    ...
    def timeResponder(username):
        if Data.Stream.isLive():
            streamStartTimeAPI = Data.Stream.requestData()['stream']['created_at']
            ...
            wordHours = Data.declensionNumsRus(deltaHours, "час", "часа", "часов")
            wordMinutes = Data.declensionNumsRus(deltaMinutes, "минуту", "минуты", "минут")
